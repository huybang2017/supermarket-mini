...
public class QuanLyGiaBanGUI extends JPanel {
    ...
    private void initComponents() {
        ...
        pnlButtons.add(createActionBtn("Cập Nhật Giá Hàng Loạt"));
        ...
        JLabel lblTu = new JLabel("Giá bán từ:"); lblTu.setFont(fontPlain);
        ...
        String[] headers = {"Mã SP", "Tên Sản Phẩm", "Giá Nhập", "Giá Bán Hiện Tại", "Ngày Cập Nhật", "Hành Động"};
